...
(async () => {
  ...
  db.exec("INSERT OR REPLACE INTO cajero (id_cajero, id_barra, nombre, usuario, password, activo) VALUES (1, (SELECT id_barra FROM barra LIMIT 1), 'Ana Torres', 'cajero_norte_1', 'demo123', 1), (2, (SELECT id_barra FROM barra LIMIT 1), 'Luis Mendoza', 'cajero_norte_2', 'demo123', 1)");
  db.exec("INSERT OR REPLACE INTO mesero (id_mesero, id_evento, id_cajero, nombre, usuario, password, activo) VALUES (9, 1, 1, 'Mesero Test', 'mesero_09', '1009', 1)");
  db.close();
